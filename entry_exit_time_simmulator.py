...
print("ENTRY EXIT TIME SIMMULATOR COMMENCING")
      
while True:
    
    urllib.request.urlopen('http://google.com') #Python 3.x
    #print("Internet Connection Detected - Current Day Simmulator")                 
    ...
    def backtest_two():
        ...
        for ticker, items_action_object in zip(ticker_list, action_object):
            ...
            src_open = pd.read_csv('modified_start_exit_times_'+ticker+'.csv')
            #src_open.iloc[200:]
            ##print(src_open)
            ...
            if(items_action_object == 2):
                ##print(ticker)
                stock_dev_money = starting_money/4
                ##print('Ticker:', ticker)
            ...
            if(length_sell_lag != -1 or length_buy_lag != -1):
                ...
                ##print(deviation_df)
                ##print(pg_concat)
                pg_concat.to_csv('entry_exit_time_simmualtor_detail.csv')
    ...
    def summary_analysis_of_sims(sum_investment_revenue_2):    
        ...
        sum_summary_array = [sum_investment_revenue_2]
        perc_summary_array = [ir2_perc]
        ...
        df_summary_combined.index = ['Full Trading Cycle Result']
        #print(df_summary_combined)
        
        df_summary_combined.to_csv('entry_exit_time_simmualtor.csv')
    
    summary_analysis_of_sims(sum_investment_revenue_2)
    
    print("ENTRY EXIT TIME SIMMULATOR COMPLETE")
