...
while True:
    ...
    ##print(end)       
    time_string_initial_data = '2024-03-05'
    ##print("Current Day:", time_string_initial_data)
    time_string_next_day = '2024-03-06'
    ...
    def backtest_two():
        ...
        starting_mone_overnighty = last_equity
        ##print(starting_mone_overnighty)
        ...
        for ticker, items_action_object in zip(ticker_list, action_object):
            ...
            mone_overnighty = starting_mone_overnighty
            
            
            
            src_open = pd.read_csv('overnight_PMAX_'+ticker+'_alert_source_tradingview_data.csv')
            #src_open.iloc[200:]
            ##print(src_open)
            ...
            for stuff in src_open['Timestamp']:
                if(stuff[0:10] == time_string_initial_data or stuff[0:10] == time_string_next_day):
                    array1.append(stuff)
                    ##print(stuff)
            ...
            if(items_action_object == 2):
                ##print(ticker)
                stock_dev_mone_overnighty = starting_mone_overnighty/len(ticker_list)
                ##print('Ticker:', ticker)
                ...
                for items_source_data, items_trade_alerts in zip(src_open['Source_Data'][index:], src_open['Trade_Alerts'][index:]):
                    ...
                    if(items_trade_alerts == 'BUY'):
                        ...
                        amount_left = stock_dev_mone_overnighty - investment_amount
                        ...
                        #quantity_shares_offset = (mone_overnighty/open_posistion_price) - quantity_shares
                        ##print("quantity_shares_offset", quantity_shares_offset)              
                        #remainder_mone_overnighty = quantity_shares_offset*open_posistion_price
                        ##print("remainder_mone_overnighty", remainder_mone_overnighty)
                        #mone_overnighty = mone_overnighty+remainder_mone_overnighty
                        ##print("Mone_overnighty:", mone_overnighty)
                        ...
                        for items_source_data, items_trade_alerts, items_timestamps in zip(src_open['Source_Data'][index:], src_open['Trade_Alerts'][index:], src_open['Timestamp'][index:]):
                            ...
                            if(items_trade_alerts == "SELL" or items_timestamps == array1[len(array1)-1]):
                                ...
                                mone_overnighty = profit_loss+amount_left
                                portfolio_total_append.append(mone_overnighty)
                                ...
                                ##mone_overnighty = mone_overnighty + amount_left
                                
                                #print("Portfolio Value:", mone_overnighty)
                                
                                stock_dev_mone_overnighty = percentage_profit_loss*stock_dev_mone_overnighty+stock_dev_mone_overnighty
    
                                
                                deviation_results.append((stock_dev_mone_overnighty))
            ...
            if(length_sell_lag != -1 or length_buy_lag != -1):
                ...
                ##print(deviation_df)
                ##print(pg_concat)
                pg_concat.to_csv('one_overnight_day_'+str(action_object[0])+'_percentage_movements.csv')
    ...
    def backtest_one_overnight():
        ...
        for ticker, items_action_object in zip(ticker_list, action_object):
            ...
            if(length_buy_lag != -1):
                ...
                #print('one_overnight DAY SIMMUALTION COMPLETE')
                
        return(sum_investment_revenue_1)
        
    sum_investment_revenue_1 = backtest_one_overnight() 
                ...
                for items_source_data, items_trade_alerts in zip(src_open['Source_Data'][index:], src_open['Trade_Alerts'][index:]):
                    ...
                    if(length_sell_lag != -1):
                        if(items_trade_alerts == "SELL"):
                            ...
                            ##percentage_gain_append.append((mone_overnighty-starting_mone_overnighty)/starting_mone_overnighty)
                            ##print(percentage_gain_append)
    ...
    def backtest_per_chance():
        ...
        for ticker, items_action_object in zip(ticker_list, action_object):
            ...
            if(length_buy_lag != 0):
                ...
                ##print(deviation_df)
                ##print(pg_concat)
                pg_concat.to_csv('one_overnight_day_3_percentage_movements.csv')
    ...
    def backtest_max_dev():
        ...
        for ticker, items_action_object in zip(ticker_list, action_object):
            ...
            if(length_sell_lag != -1 or length_buy_lag != -1):
                ...
                ##print(deviation_df)
                ##print(pg_concat)
                pg_concat.to_csv('one_overnight_day_4_percentage_movements.csv')
    ...
    def backtest_trend_perc():
        ...
        for ticker, items_action_object in zip(ticker_list, action_object):
            ...
            if(length_sell_lag != -1 or length_buy_lag != -1):
                ...
                ##print(deviation_df)
                ##print(pg_concat)
                pg_concat.to_csv('one_overnight_day_5_percentage_movements.csv')
    ...
    def summary_analysis_of_sims(sum_investment_revenue_2,sum_investment_revenue_1,sum_investment_revenue_0,sum_investment_revenue_4,sum_investment_revenue_5):    
        ...
        if(os.path.exists(r'C:\Users\jacks\Desktop\PMax Algorithm Software - L\overnight_one_overnight_day_2_percentage_movements.csv') != True):
            ir2_perc = sum_investment_revenue_2/last_equity
            #print("percentage_investment_revenue_2:", ir2_perc)
        else:
            ir2_perc = 0
            
        if(os.path.exists(r'C:\Users\jacks\Desktop\PMax Algorithm Software - L\overnight_one_overnight_day_1_percentage_movements.csv') != True):
            ir1_perc = sum_investment_revenue_1/last_equity
            #print("percentage_investment_revenue_1:", ir1_perc)
        else:
            ir1_perc = 0
            
        if(os.path.exists(r'C:\Users\jacks\Desktop\PMax Algorithm Software - L\overnight_one_overnight_day_0_percentage_movements.csv') != True):
            ir0_perc = sum_investment_revenue_0/last_equity
            #print("percentage_investment_revenue_0:", ir0_perc)
        else:
            ir0_perc = 0
            
        if(os.path.exists(r'C:\Users\jacks\Desktop\PMax Algorithm Software - L\overnight_one_overnight_day_4_percentage_movements.csv') != True):
            ir4_perc = sum_investment_revenue_4/last_equity
            #print("percentage_investment_revenue_4:", ir4_perc)
        else:
            ir4_perc = 0
            
        if(os.path.exists(r'C:\Users\jacks\Desktop\PMax Algorithm Software - L\overnight_one_overnight_day_5_percentage_movements.csv') != True):
        ...
        df_summary_combined.to_csv('overnight_intraday_simmulation_summary_analysis.csv')
